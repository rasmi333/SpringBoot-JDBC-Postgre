...
import com.rasmi.service.CustomerService;
import org.springframework.context.ApplicationContext;
@SpringBootApplication
@ComponentScan("com.rasmi.service.impl, com.rasmi.dao.impl")
public class BootstraptgreApplication {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context = SpringApplication.run(BootstraptgreApplication.class, args);
